# Adapted from https://github.com/NixOS/nixos-hardware/blob/master/framework/13-inch/common/audio.nix
{
  ...
  cfg = config.myHardware.lenovo.thinkpad.X1.gen-9.audio;
in {
  options = {
    myHardware.lenovo.thinkpad.X1.gen-9.audio = {
      enable = lib.mkOption {
        type = lib.types.bool;
        ...
        description = ''
          ...
          This option has been optimised for the ThinkPad X1 Carbon Gen 9 series, but should work on all models.
