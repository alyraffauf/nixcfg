{
  ...
  options.myHome.aly.services.icloud.enable = lib.mkEnableOption "mount iCloud Drive";

  config = lib.mkIf config.myHome.aly.services.icloud.enable {
    age.secrets.rclone-icloud.file = "${self.inputs.secrets}/aly/rclone/icloud.age";
