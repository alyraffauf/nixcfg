{
  ...
  config = {
    ...
    services.pipewire.wireplumber.configPackages = let
      ...
      prettyName = "Yoga Pro 9i Speakers";
      ...
      filter-chain = json.generate "filter-chain.json" {
        ...
        "filter.graph" = {
          ...
          links = [
            ...
            {
              output = "16IMH9eq:out_l";
              input = "woofer_bp:in_l";
            }
            {
              output = "16IMH9eq:out_r";
      ...
      configPackage =
        (pkgs.writeTextDir "share/wireplumber/wireplumber.conf.d/99-16IMH9.conf" ''
          monitor.alsa.rules = [
            {
          ...
          node.software-dsp.rules = [
            {
              ...
              actions = {
                create-filter = {
                  ...
                  hide-parent = ${lib.boolToString false}
                }
              }
            }
          ]
