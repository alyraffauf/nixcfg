{
  ...
  config = lib.mkIf config.alyraffauf.desktop.cinnamon.enable {
    ...
    dconf.settings = {
      ...
      "org/cinnamon/theme".name = config.alyraffauf.desktop.theme.gtk.name;
      "org/gnome/desktop/interface".gtk-theme = config.alyraffauf.desktop.theme.gtk.name;
      ...
      "org/gnome/desktop/interface".monospace-font-name = "${config.alyraffauf.desktop.theme.terminalFont.name} Regular ${toString config.alyraffauf.desktop.theme.terminalFont.size}";
